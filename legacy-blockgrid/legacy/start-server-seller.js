...
var address = '0x4bbb52009317D67aDd309fDF0212ED5E66e58e2F';
var key = 'b748f7af41ce1966e9527369a5342bd9c4d0bb3234080cb984ba232a045600ea';

var sell_string1 = "selling_amount";
var sell_string2 = "selling_price";
var sell_string3 = "}}]}";
...
var callback = function(error, data, response) {
  if (error) {
   ...
   var sell_amount = user_data.substring(sell_idx1+16,sell_idx2-2);
   var sell_price = user_data.substring(sell_idx2+15,sell_idx3);
   console.log(sell_amount);
   console.log(sell_price);
   var rawTx = txutils.functionTx(interface, 'registerSelling', [sell_amount, sell_price], txOptions);
   sendRaw(rawTx);
   startTransferEV(sell_amount);
   // set the field:value to send to the device
   var sensor = {
        "seller1_amount": sell_amount,
        "seller1_price": sell_price
   };
